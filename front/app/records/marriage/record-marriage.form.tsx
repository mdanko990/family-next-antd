...
import { RecordRole, SetItemProps } from "../birth/record-birth.config";
import DocumentForm from "../document.form";
import FormItemSet from "@/app/components/form-item-set";

interface RecordMarriageFormProps {
...
const RecordMarriageForm = ({ data, initialDocument, save }: RecordMarriageFormProps) => {
...
export default RecordMarriageForm;